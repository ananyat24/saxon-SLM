    ...
    <div className="flex h-screen bg-surface-alt">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-1 flex min-h-0">
          <main className="flex-1 overflow-y-auto scrollbar-thin p-6 bp-glow">
            <Outlet />
          </main>
          <div
          ...
          >
            ...
            <button
              ...
              className="absolute top-3 -left-3 w-6 h-6 rounded-full bg-surface border border-border-subtle shadow-sm flex items-center justify-center text-xs text-text-secondary hover:text-accent"
